...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CarCommand>)))
  ...
  (cl:format cl:nil "# car control command with timestamp~%# $Id$~%~%Header     header~%CarControl control~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: art_msgs/CarControl~%# car control command~%# $Id$~%~%float32 velocity                # forward velocity (m/s), negative is reverse~%float32 angle                   # steering angle (degrees)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CarCommand)))
  "Returns full string definition for message of type 'CarCommand"
  (cl:format cl:nil "# car control command with timestamp~%# $Id$~%~%Header     header~%CarControl control~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: art_msgs/CarControl~%# car control command~%# $Id$~%~%float32 velocity                # forward velocity (m/s), negative is reverse~%float32 angle                   # steering angle (degrees)~%~%~%"))
