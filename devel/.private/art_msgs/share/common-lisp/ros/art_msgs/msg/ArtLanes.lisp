...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArtLanes>)))
  ...
  (cl:format cl:nil "# ART lanes message~%# $Id$~%~%Header header~%ArtQuadrilateral[] polygons~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: art_msgs/ArtQuadrilateral~%# ART quadrilateral polygon~%# $Id$~%~%# Each of these polygons is a quadrilateral.  The four vertex points~%# are ordered relative to the heading of the lane containing it.~%~%geometry_msgs/Polygon poly~%int32 bottom_left  = 0~%int32 top_left     = 1~%int32 top_right    = 2~%int32 bottom_right = 3~%int32 quad_size = 4~%~%geometry_msgs/Point midpoint # Middle of the polygon~%~%float32 heading         # average of right and left boundary headings~%float32 length          # length of the polygon~%int32 poly_id           # unique MapLanes ID~%~%bool is_stop            # this poly has a stop waypoint~%bool is_transition      # not a lane polygon, no waypoint~%bool contains_way       # both start_way and end_way are the contained waypoint~%~%MapID start_way~%MapID end_way~%~%LaneMarking left_boundary~%LaneMarking right_boundary~%~%================================================================================~%MSG: geometry_msgs/Polygon~%#A specification of a polygon where the first and last points are assumed to be connected~%Point32[] points~%~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: art_msgs/MapID~%# Road map identifier for segments, lanes and way-points.~%# $Id$~%~%uint16 NULL_ID = 65535~%~%uint16 seg      # segment ID~%uint16 lane     # lane ID~%uint16 pt       # way-point ID~%~%================================================================================~%MSG: art_msgs/LaneMarking~%# Route Network Definition File lane marking~%# $Id$~%~%int16 DOUBLE_YELLOW = 0~%int16 SOLID_YELLOW = 1~%int16 SOLID_WHITE = 2~%int16 BROKEN_WHITE = 3~%int16 UNDEFINED = 4~%~%int16 lane_marking~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArtLanes)))
  "Returns full string definition for message of type 'ArtLanes"
  (cl:format cl:nil "# ART lanes message~%# $Id$~%~%Header header~%ArtQuadrilateral[] polygons~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: art_msgs/ArtQuadrilateral~%# ART quadrilateral polygon~%# $Id$~%~%# Each of these polygons is a quadrilateral.  The four vertex points~%# are ordered relative to the heading of the lane containing it.~%~%geometry_msgs/Polygon poly~%int32 bottom_left  = 0~%int32 top_left     = 1~%int32 top_right    = 2~%int32 bottom_right = 3~%int32 quad_size = 4~%~%geometry_msgs/Point midpoint # Middle of the polygon~%~%float32 heading         # average of right and left boundary headings~%float32 length          # length of the polygon~%int32 poly_id           # unique MapLanes ID~%~%bool is_stop            # this poly has a stop waypoint~%bool is_transition      # not a lane polygon, no waypoint~%bool contains_way       # both start_way and end_way are the contained waypoint~%~%MapID start_way~%MapID end_way~%~%LaneMarking left_boundary~%LaneMarking right_boundary~%~%================================================================================~%MSG: geometry_msgs/Polygon~%#A specification of a polygon where the first and last points are assumed to be connected~%Point32[] points~%~%================================================================================~%MSG: geometry_msgs/Point32~%# This contains the position of a point in free space(with 32 bits of precision).~%# It is recommeded to use Point wherever possible instead of Point32.  ~%# ~%# This recommendation is to promote interoperability.  ~%#~%# This message is designed to take up less space when sending~%# lots of points at once, as in the case of a PointCloud.  ~%~%float32 x~%float32 y~%float32 z~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: art_msgs/MapID~%# Road map identifier for segments, lanes and way-points.~%# $Id$~%~%uint16 NULL_ID = 65535~%~%uint16 seg      # segment ID~%uint16 lane     # lane ID~%uint16 pt       # way-point ID~%~%================================================================================~%MSG: art_msgs/LaneMarking~%# Route Network Definition File lane marking~%# $Id$~%~%int16 DOUBLE_YELLOW = 0~%int16 SOLID_YELLOW = 1~%int16 SOLID_WHITE = 2~%int16 BROKEN_WHITE = 3~%int16 UNDEFINED = 4~%~%int16 lane_marking~%~%~%"))
