...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IOadrState>)))
  ...
  (cl:format cl:nil "# NCD IOADR8x controller state message for ART vehicle~%~%# $Id$~%~%Header  header~%~%# constant bit values for relays and digitalB inputs~%uint8 ENABLED      =   1~%uint8 RUN          =   2~%uint8 FLASHER      =   4~%uint8 ALARM        =   8~%uint8 LASER_FRONT  =  16~%uint8 LASER_TOP    =  32~%uint8 TURN_LEFT    =  64~%uint8 TURN_RIGHT   = 128~%~%uint8   relays                  # current relays settings~%~%uint8   digitalB                # digital input B~%~%# generally, voltages[0] is the steering position sensor~%int32 N_VOLTAGES = 3            # number of analog voltages~%float32[3] voltages             # analog voltages [A, B, C]~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IOadrState)))
  "Returns full string definition for message of type 'IOadrState"
  (cl:format cl:nil "# NCD IOADR8x controller state message for ART vehicle~%~%# $Id$~%~%Header  header~%~%# constant bit values for relays and digitalB inputs~%uint8 ENABLED      =   1~%uint8 RUN          =   2~%uint8 FLASHER      =   4~%uint8 ALARM        =   8~%uint8 LASER_FRONT  =  16~%uint8 LASER_TOP    =  32~%uint8 TURN_LEFT    =  64~%uint8 TURN_RIGHT   = 128~%~%uint8   relays                  # current relays settings~%~%uint8   digitalB                # digital input B~%~%# generally, voltages[0] is the steering position sensor~%int32 N_VOLTAGES = 3            # number of analog voltages~%float32[3] voltages             # analog voltages [A, B, C]~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
