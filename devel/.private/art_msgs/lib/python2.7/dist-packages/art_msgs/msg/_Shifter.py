...
"""autogenerated by genpy from art_msgs/Shifter.msg. Do not edit."""
import sys
...
class Shifter(genpy.Message):
  _md5sum = "dddb61d8575e01ea7857ef1b3a7b941c"
  _type = "art_msgs/Shifter"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# ART shifter message
#
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Shifter, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2B.pack(_x.gear, _x.relays))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gear, _x.relays,) = _struct_2B.unpack(str[start:end])
      return self
