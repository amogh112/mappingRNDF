...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LaneMarking>)))
  ...
  (cl:format cl:nil "# Route Network Definition File lane marking~%# $Id$~%~%int16 DOUBLE_YELLOW = 0~%int16 SOLID_YELLOW = 1~%int16 SOLID_WHITE = 2~%int16 BROKEN_WHITE = 3~%int16 UNDEFINED = 4~%~%int16 lane_marking~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LaneMarking)))
  "Returns full string definition for message of type 'LaneMarking"
  (cl:format cl:nil "# Route Network Definition File lane marking~%# $Id$~%~%int16 DOUBLE_YELLOW = 0~%int16 SOLID_YELLOW = 1~%int16 SOLID_WHITE = 2~%int16 BROKEN_WHITE = 3~%int16 UNDEFINED = 4~%~%int16 lane_marking~%~%~%"))
