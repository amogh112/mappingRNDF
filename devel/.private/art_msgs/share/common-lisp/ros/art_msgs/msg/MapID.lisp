...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MapID>)))
  ...
  (cl:format cl:nil "# Road map identifier for segments, lanes and way-points.~%# $Id$~%~%uint16 NULL_ID = 65535~%~%uint16 seg      # segment ID~%uint16 lane     # lane ID~%uint16 pt       # way-point ID~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MapID)))
  "Returns full string definition for message of type 'MapID"
  (cl:format cl:nil "# Road map identifier for segments, lanes and way-points.~%# $Id$~%~%uint16 NULL_ID = 65535~%~%uint16 seg      # segment ID~%uint16 lane     # lane ID~%uint16 pt       # way-point ID~%~%~%"))
