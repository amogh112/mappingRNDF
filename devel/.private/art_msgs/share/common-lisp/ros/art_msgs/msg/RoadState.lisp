...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RoadState>)))
  ...
  (cl:format cl:nil "# Navigator Road state values~%# $Id$~%~%uint16 Init      = 0~%uint16 Block     = 1~%uint16 Evade     = 2~%uint16 Follow    = 3~%uint16 Pass      = 4~%uint16 Uturn     = 5~%uint16 WaitCross = 6~%uint16 WaitLane  = 7~%uint16 WaitPass  = 8~%uint16 WaitStop  = 9~%uint16 Zone      = 10~%uint16 N_states  = 11~%~%uint16 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RoadState)))
  "Returns full string definition for message of type 'RoadState"
  (cl:format cl:nil "# Navigator Road state values~%# $Id$~%~%uint16 Init      = 0~%uint16 Block     = 1~%uint16 Evade     = 2~%uint16 Follow    = 3~%uint16 Pass      = 4~%uint16 Uturn     = 5~%uint16 WaitCross = 6~%uint16 WaitLane  = 7~%uint16 WaitPass  = 8~%uint16 WaitStop  = 9~%uint16 Zone      = 10~%uint16 N_states  = 11~%~%uint16 state~%~%~%"))
