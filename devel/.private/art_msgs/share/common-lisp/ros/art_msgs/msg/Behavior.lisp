...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Behavior>)))
  ...
  (cl:format cl:nil "# ART Navigator behaviors (lower numbers have higher priority)~%# $Id$~%~%# enumerated behavior values~%int16 Abort       = 0~%int16 Quit        = 1~%int16 Pause       = 2~%int16 Run         = 3~%int16 Suspend     = 4~%int16 Initialize  = 5~%int16 Go          = 6~%int16 NONE        = 7~%int16 N_behaviors = 8~%~%int16 value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Behavior)))
  "Returns full string definition for message of type 'Behavior"
  (cl:format cl:nil "# ART Navigator behaviors (lower numbers have higher priority)~%# $Id$~%~%# enumerated behavior values~%int16 Abort       = 0~%int16 Quit        = 1~%int16 Pause       = 2~%int16 Run         = 3~%int16 Suspend     = 4~%int16 Initialize  = 5~%int16 Go          = 6~%int16 NONE        = 7~%int16 N_behaviors = 8~%~%int16 value~%~%~%"))
